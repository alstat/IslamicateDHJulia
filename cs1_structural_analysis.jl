...
# ╔═╡ 59cfe94f-580c-45ff-8b75-98d3481aa022
using DataFrames

# ╔═╡ 2c2d8011-4b38-4e29-ab41-7d5f463b7637
using CairoMakie

# ╔═╡ 92092368-aa37-493e-825b-b8ea1cf19e66
using QuranTree

# ╔═╡ ed68ddab-c76d-40f9-8fc9-37693307e9e5
using Yunir

# ╔═╡ de429050-d468-4f8c-94db-786ea6275548
using Statistics

# ╔═╡ f0876ef6-dd0e-4644-a35e-ac995308179e
using Embeddings

# ╔═╡ d67e5622-b91f-4530-b086-28ae187f7f59
begin
	using Dates
	using HypertextLiteral: @htl
end

# ╔═╡ 80d409ca-f66d-4d3f-8f6a-c4daa1b232dd
@htl("""
<div class="ar-sch basmala">بسم الله الرحمن الرحيم</div>
<div style="text-align: right; font-size: 14px;">last updated:  $(Dates.now())</div>
""")

# ╔═╡ 20ebc111-bc81-4b3a-ab67-3f1ebf167d23
md"""
# Structural Analysis of the Qur'an using Hierarchical Clustering of the Ayah's Word Embedding
_by Al-Ahmadgaid B. Asaad_
"""

# ╔═╡ 94519f79-79da-4072-bf97-8bb02a8bbd28
md"""
__Abstract__: The Qur'an does not explicitly reveal an obvious structure compared to a typical book. Indeed, early Muslim scholars have noticed this and pioneered the work on structural analysis of the said scripture. In this study, we are going to use a Statistical analysis to get another perspective from on the structure of the Qur'an through Hierarchical Clustering. This is done by using the encoding the Qur'anic words into a _word embedding_.
"""

# ╔═╡ e8d171a3-cb96-4375-855d-d9cec6b7224a
crps, tnzl = load(QuranData());

# ╔═╡ f0060154-3e83-41d2-a49b-6b3c1cfe177a
arabic("bi")

# ╔═╡ c999b202-bcfb-49bb-9254-91e550b8f340
crps_tbl = table(crps)

# ╔═╡ 3a4f90c0-d467-4726-82bd-f970aa832611
tnzl_tbl = table(tnzl)

# ╔═╡ 39c17b54-285c-4eee-8276-5065a6e9853f
@htl("""
...
git-tree-sha1 = "f30cd74d51a368bf3895d877215513fa6d36722f"
...
git-tree-sha1 = "8e11385afdbdbdedfefe4cc249a42ee7ef97b38c"
...
[[Yunir]]
deps = ["BioAlignments", "CairoMakie", "Colors", "Makie", "Test"]
git-tree-sha1 = "ec1adb55a73ece0412a2cfeea91345a6575be9f1"
